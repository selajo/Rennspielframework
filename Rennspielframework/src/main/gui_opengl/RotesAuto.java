...
/**
 * Repräsentiert ein rotes Fahrzeug
 */
public class RotesAuto extends GameObject {
    Texture up1, down1, left1, right1;

    RotesAuto(){
        Spieloptionen optionen = Spieloptionen.getInstance();

        up1 = ResourceManager.getCarTexture("1", "1");
        down1 = ResourceManager.getCarTexture("1", "2");
        left1 = ResourceManager.getCarTexture("1", "3");
        right1 = ResourceManager.getCarTexture("1", "4");
