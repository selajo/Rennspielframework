...
/**
 * Klasse die ein blaues Fahrzeug repraesentiert mir seinen grafischen Anzeigedaten
 * @author André
 *
 */
public class BlauesAuto extends Entity{
	EventManager event; 
	 ...
	 * @param controller
	 */
	public BlauesAuto(Controller controller) { //Konstruktor
	...
	public void getAutoImage() {
		...
		up1 = opt.autoTiles.get(2).get(1);
		down1 = opt.autoTiles.get(2).get(2); 
		left1 = opt.autoTiles.get(2).get(3);  
		right1 = opt.autoTiles.get(2).get(4);	
	}
