...
/**
 * Klasse die ein rotes Fahrzeug repraesentiert mir seinen grafischen Anzeigedaten
 * @author André
 *
 */
public class RotesAuto extends Entity {
	EventManager event; 
	 ...
	 * @param controller
	 */
	public RotesAuto(Controller controller) { //Konstruktor
	...
	public void getAutoImage() {
			...
			up1 = opt.autoTiles.get(1).get(1);
			down1 = opt.autoTiles.get(1).get(2); 
			left1 = opt.autoTiles.get(1).get(3);  
			right1 = opt.autoTiles.get(1).get(4); 	
	}
