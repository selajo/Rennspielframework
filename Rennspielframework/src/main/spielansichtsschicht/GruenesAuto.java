...
/**
 * Klasse die ein gruenes Fahrzeug repraesentiert mir seinen grafischen Anzeigedaten
 * @author André
 *
 */
public class GruenesAuto  extends Entity {
	EventManager event; 
	 ...
	 * @param controller
	 */
	public GruenesAuto(Controller controller) { //Konstruktor
	...
	public void getAutoImage() {
		...
		up1 = opt.autoTiles.get(3).get(1);
		down1 = opt.autoTiles.get(3).get(2); 
		left1 = opt.autoTiles.get(3).get(3);  
		right1 = opt.autoTiles.get(3).get(4);
	}
